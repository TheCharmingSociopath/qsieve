...
def two_level_15to1_state(
    ...
    """
    Generates the output-state density matrix of the (15-to-1)x(15-to-1) protocol
...
def cost_of_two_level_15to1(
    ...
    # Generate output state of (15-to-1)x(15-to-1) protocol
